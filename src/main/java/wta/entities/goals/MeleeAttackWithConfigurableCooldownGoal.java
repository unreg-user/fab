...
public class MeleeAttackWithConfigurableCooldownGoal extends Goal {
    ...
    public MeleeAttackWithConfigurableCooldownGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle, int attackIntervalTicks) {
        this.mob = mob;
        this.speed = speed;
