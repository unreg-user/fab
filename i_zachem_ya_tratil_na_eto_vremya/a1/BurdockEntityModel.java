...
public class BurdockEntityModel extends SinglePartEntityModel<BurdockEntity> {
	...
	@Override
	public void setAngles(BurdockEntity burdock, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
